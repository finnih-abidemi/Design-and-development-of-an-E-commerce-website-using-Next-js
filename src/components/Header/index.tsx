...
const Header = () => {
  return (
    <nav className='flex px-10 h-[80px] bg-[whitesmoke] shadow-lg  w-full items-center justify-between'>
        ...
        <div className="flex gap-3 ">
            ...
            <div className="flex gap-3 items-center hover:bg-gray-200 rounded-md cursor-pointer px-3">
