    ...
    <div className='container px-[30px] md:px-0'>
        <main className='flex md:flex-row flex-col gap-10 items-center justify-center'>
            <div className="flex flex-col gap-8 md:max-w-[50%]">
                <MainTitle text='Deals of the day' subText='Celebrate the holidays in style with our special deals on home decor and furniture. Transform your place into a winter wonderland without stretching your budget.' />
