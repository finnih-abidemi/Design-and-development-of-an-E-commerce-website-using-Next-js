        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[500px] rounded-md bg-gray-900 bg-opacity-5 py-10 px-6  sm:p-[60px] ">
                ...
                <button className="mb-6 flex w-full items-center justify-center rounded-md bg-white p-3 text-base font-medium text-body-color shadow-one hover:text-primary hover:text-blue-700">
                  <span className="mr-3">
                    <svg
                      width="20"
                      height="20"
                    ...
                    <input
                      ...
                      className={`w-full rounded-md border ${
                        error && firstName === ""
                          ? "border-[#e94949]"
                          : "border-transparent"
                      } py-3 px-6 text-base text-body-color placeholder-body-color shadow-one outline-none focus:border-primary focus-visible:shadow-none dark:shadow-signUp`}
                    />
                    {error && firstName === "" && (
                      <p className="mt-1 ml-3 text-[13px] text-[#e94949]">
                ...
                <p className="text-center text-[14px] font-small text-body-color">
                  Already using Startup?
                  <Link href="/login" className="text-primary ml-3 hover:underline text-blue-700">
                    Sign in
                  </Link>
                </p>
              </div>
